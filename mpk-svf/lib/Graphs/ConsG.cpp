...
//
//    PAGEdge::PAGEdgeSetTy& insertVals = getPAGEdgeSet(PAGEdge::ExtractVal);
//    for (PAGEdge::PAGEdgeSetTy::iterator iter = insertVals.begin(), eiter =
//            insertVals.end(); iter != eiter; ++iter)
//    {
//        PAGEdge* edge = *iter;
//        addExtractValCGEdge(edge->getSrcID(),edge->getDstID(),SVFUtil::cast<ExtractValPE>(edge)->getLocationSet());
//    }
//
//    PAGEdge::PAGEdgeSetTy& extractVals = getPAGEdgeSet(PAGEdge::InsertVal);
//    for (PAGEdge::PAGEdgeSetTy::iterator iter = extractVals.begin(), eiter =
//            extractVals.end(); iter != eiter; ++iter)
//    {
//        PAGEdge* edge = *iter;
//        addInsertValCGEdge(edge->getSrcID(),edge->getDstID(),SVFUtil::cast<InsertValPE>(edge)->getLocationSet());
//    }
}
