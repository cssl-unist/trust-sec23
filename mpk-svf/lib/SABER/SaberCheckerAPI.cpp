...
{
    {"__rust_alloc",SaberCheckerAPI::CK_ALLOC},
    {"__rust_alloc_zeroed",SaberCheckerAPI::CK_ALLOC},
    {"__rust_realloc",SaberCheckerAPI::CK_ALLOC},
    ...
    {"__rust_dealloc",SaberCheckerAPI::CK_FREE},
