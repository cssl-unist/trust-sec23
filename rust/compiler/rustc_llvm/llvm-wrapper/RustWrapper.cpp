...
LLVMRustDIBuilderCreateDebugLocation(LLVMContextRef ContextRef, unsigned Line,
                                     ...
                                     LLVMMetadataRef InlinedAt, unsigned IsUnsafe) {
  LLVMContext &Context = *unwrap(ContextRef);
return wrap(DebugLoc::get(Line, Column, unwrapDIPtr<MDNode>(Scope),
                          unwrapDIPtr<MDNode>(InlinedAt), IsUnsafe?true: false).getAsMDNode());
}
