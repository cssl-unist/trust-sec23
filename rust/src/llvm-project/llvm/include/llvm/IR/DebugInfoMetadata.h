...
class DILocation : public MDNode {
  ...
  DILocation(LLVMContext &C, StorageType Storage, unsigned Line,
             unsigned Column, ArrayRef<Metadata *> MDs, /*MPK-Unsafe*/bool InUnsafeBlock, bool ImplicitCode);
  ~DILocation() { dropAllReferences(); }

  static DILocation *getImpl(LLVMContext &Context, unsigned Line,
                             unsigned Column, Metadata *Scope,
                             Metadata *InlinedAt, /*MPK-Unsafe*/bool InUnsafeBlock, bool ImplicitCode,
                             StorageType Storage, bool ShouldCreate = true);
  static DILocation *getImpl(LLVMContext &Context, unsigned Line,
                             unsigned Column, DILocalScope *Scope,
                             DILocation *InlinedAt,/*MPK-Unsafe*/bool InUnsafeBlock, bool ImplicitCode,
                             StorageType Storage, bool ShouldCreate = true) {
    return getImpl(Context, Line, Column, static_cast<Metadata *>(Scope),
                   static_cast<Metadata *>(InlinedAt), InUnsafeBlock, ImplicitCode, Storage,
                   ShouldCreate);
  }
  ...
  TempDILocation cloneImpl() const {
    ...
    return getTemporary(getContext(), getLine(), getColumn(), getRawScope(),
                        getRawInlinedAt(), isInUnsafeBlock(), isImplicitCode());
  }
...
public:
  ...
  DEFINE_MDNODE_GET(DILocation,
                    (unsigned Line, unsigned Column, Metadata *Scope,
                     Metadata *InlinedAt = nullptr, /*MPK-Unsafe*/ bool InUnsafeBlock = false, bool ImplicitCode = false),
                    (Line, Column, Scope, InlinedAt, InUnsafeBlock, ImplicitCode))
  DEFINE_MDNODE_GET(DILocation,
                    (unsigned Line, unsigned Column, DILocalScope *Scope,
                     DILocation *InlinedAt = nullptr,
                     /*MPK-Unsafe*/ bool InUnsafeBlock = false,
  ...
  bool isInUnsafeBlock() const { return InUnsafeBlock; }
  void setImplicitCode(bool ImplicitCode) { this->ImplicitCode = ImplicitCode; }
  void setInUnsafeBlock(bool InUnsafeCode) { this->InUnsafeBlock = InUnsafeBlock; }
