...
protected:
  Metadata(unsigned ID, StorageType Storage)
      : SubclassID(ID), Storage(Storage), ImplicitCode(false), InUnsafeBlock(false) {
    //static_assert(sizeof(*this) == 16, "Metadata fields poorly packed");
  }
