...
bool LLParser::ParseFnAttributeValuePairs(AttrBuilder &B,
  ...
  while (true) {
    ...
    //MPK-attributes
    case lltok::kw_mpk_extern: B.addAttribute(Attribute::MPKExtern); break;
    case lltok::kw_mpk_immut: B.addAttribute(Attribute::MPKImmut); break;
    case lltok::kw_mpk_unsafe: B.addAttribute(Attribute::MPKUnsafe); break;
    // Error handling.
    case lltok::kw_inreg:
...
#define VISIT_MD_FIELDS(OPTIONAL, REQUIRED)                                    \
  ...
  OPTIONAL(isInUnsafeBlock, MDBoolField, (false));                               \
...
#undef VISIT_MD_FIELDS
  ...
  Result =
      GET_OR_DISTINCT(DILocation, (Context, line.Val, column.Val, scope.Val,
                                   inlinedAt.Val, isInUnsafeBlock.Val, isImplicitCode.Val));
  return false;
}
