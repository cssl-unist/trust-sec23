...
std::string Attribute::getAsString(bool InAttrGrp) const {
  ...
  //MPK-attributes
  if (hasAttribute(Attribute::MPKExtern))
    return "mpk_extern";
  if (hasAttribute(Attribute::MPKImmut))
     return "mpk_immut";
  if (hasAttribute(Attribute::MPKUnsafe))
    return "mpk_unsafe";
...
AttrBuilder AttributeFuncs::typeIncompatible(Type *Ty) {
  ...
  if (!Ty->isPointerTy())
    ...
    Incompatible.addAttribute(Attribute::Nest)
        ...
        .addAttribute(Attribute::MPKImmut)
        .addAttribute(Attribute::MPKUnsafe)
